...
#define FILLING_STATION_NOS_VALVE_CLOSED_GPIO_INDEX      (uint8_t)0x02
#define FILLING_STATION_NOS_VALVE_OPENED_GPIO_INDEX      (uint8_t)0x03
#define FILLING_STATION_NOS_DUMP_VALVE_CLOSED_GPIO_INDEX (uint8_t)0x04
#define FILLING_STATION_NOS_DUMP_VALVE_OPENED_GPIO_INDEX (uint8_t)0x05
